...
////        }
//
//        int cryptoCount = (int) cryptoCurrencyRepository.count();
//        if (cryptoCount > LIMIT_LINE) {
//            int itemsToDelete = cryptoCount - LIMIT_LINE;
//            cryptoCurrencyRepository.deleteOldestEntries(itemsToDelete);
//            logger.info("Supprimé {} entrées les plus anciennes de CryptoCurrency", itemsToDelete);
//        }
//
//        int marketDataCount = (int) marketDataRepository.count();
//        if (marketDataCount > LIMIT_LINE) {
//            int itemsToDelete = marketDataCount - LIMIT_LINE;
//            marketDataRepository.deleteOldestMarketData(itemsToDelete);
//            logger.info("Supprimé {} entrées les plus anciennes de MarketData", itemsToDelete);
//        }
//    }
//}
